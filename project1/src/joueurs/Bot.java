...
public class Bot extends Joueur {
    ...
    public int repondreAccu() {
    	System.out.println("Joueur : "+ this.getNom() + ", vous etes accus�.");
    ...
    public Joueur jouerCarte(Carte carteChoisi, String effet, ArrayList<Joueur> listJ, int indexActu, int indexdelautre, LinkedList<Carte> deffausseGeneral) {
        ...
        case "Angry Mob": 
        	if(effet=="witch") {
    			...
    			//Choisir qui joueur
    			System.out.println("Choississez le joueur � qui r�v�ler son identit� de mani�re forc�");
    			Jdesigner=this.choisirVictime(restrictChoix, listJ);
    			Jdesigner.setEtatcarte(true);
    			System.out.println("*******************************************************************************");
    			System.out.println("************R�v�lation de l'identit� du joueur :  " + Jdesigner.getNom() + "***********");
    			if(Jdesigner.isIdentite()==true) {
    				System.out.println("Identit� du joueur d�sign� : SORCIERE ");
    				...
    				System.out.println("************Identit� du joueur d�sign� : VILLAGEOIS ");
    				this.setScore(-2);
    				System.out.println("Accusatueur :  " + this.getNom() + " pert 2points ***********");
    				System.out.println("Accus� :  " + Jdesigner.getNom() + " prend la main ***********");
    			}
    			System.out.println("*******************************************************************************");
        ...
        case "The Inquisition":
        	if(effet=="witch") {
		        ...
		        while(cartfct.hasNext()) {
		        	...
		        	System.out.println(C.getNom() + "� index :  "+ m1.indexOf(C));
		        	restrictChoix[restrict]=m1.indexOf(C);
					restrict++;}
		        System.out.println("Choississez la carte � mettre en d�fausse g�n�rale : entrer l'index de la carte");
		        Carte carteRecup=this.choisirCarte(restrictChoix, m1);
				System.out.println("Carte choisi et en d�fausse g�n�rale : " + carteRecup.getNom());
				this.getMain().remove(carteRecup);
				deffausseGeneral.add(carteRecup);
		        //erreur de compr�hension de ma part sur les cartes rejet�s
		      ...
		      //Tableau reinistialiser valeur
    			...
    			System.out.println("*******************************************************************************");
    			System.out.println("************Ceci est secret et � destination de :  " + this.getNom() + "***********");
    			if(Jdesigner.isIdentite()==true) {
    			System.out.println("************Identit� du joueur d�sign� : SORCIERE ");}
    			else {
    				System.out.println("************Identit� du joueur d�sign� : VILLAGEOIS ");
        ...
        case "Pointed Hat":
        	if(effet=="witch") {
        		...
        		System.out.println("Vos carte jou� et r�v�l� :");
		        
		        while(cartfct.hasNext()) {
		        	Carte C=cartfct.next();
		        	System.out.println("Les cartes r�v�l� sont : \n");
		        	System.out.println(C.getNom() + "� index :  "+ deffoss.indexOf(C));
		        	restrictChoix[restrict]=deffoss.indexOf(C);
					restrict++;}
		        System.out.println("Entrer l'index de la carte que vous souhaitez r�cup�rer en main parmi carte d�j� jou�");
		        Carte carteRecup=this.choisirCarte(restrictChoix, deffoss);
				System.out.println("Carte choisi et r�cup�rer dans la main : " + carteRecup.getNom());
        ...
        case "Hooked Nose":
        	if(effet=="witch") {
        		...
        		//prendre le tour suivant
        		System.out.println("Le joueur actuel   " + this.getNom() + "  joue le prochain tour");
        		//cas de force majeur mais �a devrait marcher j'esp�re ????
        ...
        case "Ducking Stool":
        	if(effet=="witch") {
    			...
    			Jdesigner=this.choisirVictime(restrictChoix, listJ);
    			System.out.println("Joueur  " + Jdesigner.getNom()  +  "choisisser si vous voulez r�l�ver identit� :  ");
    			...
    			if(choix==0) {
    				...
    				if(Jdesigner.isIdentite()==true) {
    					System.out.println("Joueur s�lectionn� est une sorciere");
    					Jdesigner.setEtatcarte(true);
    					Jdesigner.setEtatjeu(false);
    					this.setScore(1);
    					...
    					System.out.println("Joueur s�lectionn� est un villageois");
    					Jdesigner.setEtatcarte(true);
    					this.setScore(-1);
        ...
        case "Cauldron":
        	if(effet=="witch") {
        		...
        		System.out.println("Le joueur actuel   " + this.getNom() + "  r�v�le son identit� !!!");
        ...
        case "Black Cat":
        	if(effet=="witch") {
		        ...
		        while(cartfct.hasNext()) {
		        	Carte C=cartfct.next();
		        	System.out.println("Les cartes en main sont : \n");
		        	System.out.println(C.getNom() + "� index :  "+ deffausseGeneral.indexOf(C));
		        	restrictChoix[restrict]=deffausseGeneral.indexOf(C);
					restrict++;}
		        System.out.println("Choississez la carte de la d�fausse g�n�rale � prendre en main : entrer l'index de la carte");
        	...
        	if(effet=="witch") {
    			...
    			while(itfct.hasNext()) {
    				...
    				if(A.getEtatjeu()==true && listJ.indexOf(A)!=listJ.indexOf(this) && A.getDefausse().size()>0) {
    					restrictChoix[restrict]=listJ.indexOf(A);
    					restrict++;
    				System.out.println("index : " + listJ.indexOf(A) + "Joueur : " + A.getNom() + "Nombre de carte en r�v�l� :  "+ A.getDefausse().size() );
    				
    				//
    				deffoss=A.getDefausse();
            		cartfct=deffoss.iterator();
            		
            		System.out.println("Les cartes r�v�l� de ce joueurs sont :   ");
    			...
    			//Choisir qui joueur
    			System.out.println("Choississez le joueur � qui prendre une carte r�v�l� :");
    			Jdesigner=this.choisirVictime(restrictChoix, listJ);
        		...
        		System.out.println("Rappel : Les cartes r�v�l� de ce joueur sont :   ");
		        while(cartfct.hasNext()) {
		        	Carte C=cartfct.next();
		        	System.out.println(C.getNom() + "� index :  "+ deffoss.indexOf(C));
		        	restrictChoix[restrict]=deffoss.indexOf(C);
